		...
		return [
			{
				...
				headers: [
					...
					},
					{
						...
						value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' https://a.storyblok.com data:; font-src 'self'; connect-src 'self' https://api.storyblok.com; frame-ancestors 'none';",
					},
				],
			},
		];
