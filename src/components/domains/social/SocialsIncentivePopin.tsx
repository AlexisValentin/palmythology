	...
	return (
		<div
			className={`hidden lg:flex fixed right-0 top-1/2 -translate-y-1/2 z-40 transition-transform duration-300 ${
				isExpanded
					? "translate-x-0"
					: "md:translate-x-[calc(100%-2.2rem)] lg:translate-x-[calc(100%-2.2rem)] xl:translate-x-[calc(100%-2.2rem)] 2xl:translate-x-[calc(100%-2.2rem)]"
			}`}
		>
			<button
				type="button"
			...
			<div className="bg-white rounded-r-lg shadow-2xl p-6 md:w-24 lg:w-40 xl:w-56 2xl:w-72">
				<div>
					<p className="text-sm text-center text-gray-600 mb-4">
						Le meilleur moyen de soutenir la Palmythology, c'est sur les réseaux
						sociaux !
					</p>
