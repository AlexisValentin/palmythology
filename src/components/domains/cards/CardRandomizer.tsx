  ...
  return (
    <div className="mt-16">
      ...
      <Link
        ...
        className="group flex justify-center flex-col md:flex-row items-center mt-4 border border-black rounded-lg overflow-hidden hover:bg-black"
      >
        <Image
        ...
        <div className="m-4 max-h-80">
          ...
          <div className="flex text-center md:text-left mt-4 md:mt-0">
            <div className="italic max-w-80 md:max-w-96 group-hover:text-white text-ellipsis overflow-hidden">
