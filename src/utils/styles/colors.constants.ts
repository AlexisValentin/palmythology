...
export const TEXT_COLORS = {
	...
	EGYPTIAN: `${COLORS.NEUTRAL}-${COLOR_TAINTS.EXTRA_DARK}`,
	HINDU: `${COLORS.EMERALD}-${COLOR_TAINTS.EXTRA_DARK}`,
	JAPANESE: `${COLORS.RED}-${COLOR_TAINTS.SUPER_DARK}`,
	ROMAN: `${COLORS.AMBER}-${COLOR_TAINTS.DARKER}`,
};

export const MYTHOLOGY_COLORS = {
	AZTEC: `${COLORS.ORANGE}-${COLOR_TAINTS.DARKER}`,
	CELTIC: `${COLORS.EMERALD}-${COLOR_TAINTS.DARKER}`,
	CHINESE: `${COLORS.RED}-${COLOR_TAINTS.DARKER}`,
	EGYPTIAN: `${COLORS.AMBER}-${COLOR_TAINTS.LIGHT}`,
	GREEK: `${COLORS.BLUE}-${COLOR_TAINTS.DARKER}`,
	HINDU: `${COLORS.AMBER}-${COLOR_TAINTS.MEDIUM}`,
	...
	NORSE: `${COLORS.SKY}-${COLOR_TAINTS.MEDIUM}`,
