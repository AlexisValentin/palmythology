...
export const SEO_WORDING: Record<string, SeoWordingType> = {
  HOME: {
    ...
    description: `Découvrez les mythologies du monde en plongeant dans l'histoire et la culture divine à travers des fiches simple, intuitives et pédagogiques. Que vous souhaitiez en savoir plus sur les dieux, déesses, héros légendaires ou créatures mythiques, la Palmythology saura vous transporter dans une aventure éducative et divertissante !`,
  },
  NEWS: {
    title: 'Actualités',
